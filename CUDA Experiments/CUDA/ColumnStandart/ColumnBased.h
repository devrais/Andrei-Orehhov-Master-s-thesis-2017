...
/* Function will find chosen value in column
 */
__global__ void scaleCudaColumn(int *d_column, int *d_count);

// Function will substitute chosen value by SearchTarget
__global__ void substituteCudaColumnValue(int *d_column);

// Will set incrementor to zero. It will be used "scaleCudaColumn" and "substituteColumnCudaValue"
