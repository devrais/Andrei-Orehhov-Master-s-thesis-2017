...
//#define INITIAL_SUBAREA_SIZE 4000  /** size of the first created subarea (bytes)  */
...
extern "C" {
#endif
__device__ gint wg_init_db_memsegment(void* db, gint key, gint size); // creates initial memory structures for a new db
...
//void *copy_local_db_to_cuda(void *db, gint size);
