...
__device__ void* wg_cuda_create_record(void* db, wg_int length); ///< returns NULL when error, ptr to rec otherwise
__device__ void* wg_create_record(void* db, wg_int length); ///< returns NULL when error, ptr to rec otherwise
__device__ void* wg_create_raw_record(void* db, wg_int length); ///< returns NULL when error, ptr to rec otherwise
...
__device__ wg_int wg_get_record_len(void* db, void* record); ///< returns negative int when error
...
__device__ wg_int wg_get_field(void* db, void* record, wg_int fieldnr);      // returns 0 when error
__device__ wg_int wg_cuda_get_field(void* db, void* record, wg_int fieldnr);      // returns 0 when error
wg_int wg_get_field_type(void* db, void* record, wg_int fieldnr); // returns 0 when error


/* ---------- general operations on encoded data -------- */

__device__ wg_int wg_get_encoded_type(void* db, wg_int data);
...
__device__ wg_int wg_decode_int(void* db, wg_int data);
__device__ wg_int wg_cuda_decode_int(void* db, wg_int data);
...
__device__ char* wg_decode_str(void* db, wg_int data);
...
__device__ char* wg_decode_unistr(void* db, wg_int data, gint type);
__device__ char* wg_decode_unistr_lang(void* db, wg_int data, gint type);

__device__ gint wg_decode_unistr_len(void* db, wg_int data, gint type);
__device__ gint wg_decode_unistr_lang_len(void* db, wg_int data, gint type);
